...
# Eval-stage pods benchmark checkpoints (GIFT-Eval/BOOM/TIME gate) and need the
# pinned data at $POD_WORKDIR/bench_data — heat pods never touch it, and 4.4G
# would slow their boot for nothing. FINAL pods (post-publish cascade bench,
# PR 174) self-provision it instead: the bench remote command downloads on
