...
__all__ = [
    ...
    "train_one", "val_crps",
    "batched_quantiles",
    "eval_gift_dev", "eval_gift_full", "gift_all_specs", "quick_wiring_test", "DEV_SETS",
    "eval_time",
...
_LAZY = {
    ...
    "batched_quantiles": "infer",
    "eval_gift_dev": "gift_eval", "eval_gift_full": "gift_eval",
    "gift_all_specs": "gift_eval", "quick_wiring_test": "gift_eval", "DEV_SETS": "gift_eval",
    "eval_time": "time_eval",
