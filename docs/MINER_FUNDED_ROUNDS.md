...
evening flip (9046800) — the previously pinned image predates the vault fetch
(and the `batch_denomination` contract field), so booting it after go-live
either fails funded legs or trains under a mismatched contract.
