"""Declared-contract gating (DEC-CA-0029).
...
def test_trainer_side_change_scores_on_an_un_upgraded_validator(armed, field, value):
    # The trainer moves; the validator's chain.toml does NOT. Before DEC-CA-0029
...
def test_locked_terms_still_reject(armed, field, value):
    ...
    # base_arch_digest has its own dedicated gate that fires first; the other two
